...
public:
    ...
    void setupUi(QWidget *Online)
    {
        ...
        OnlineFriend = new QListWidget(Online);
        OnlineFriend->setObjectName("OnlineFriend");

        horizontalLayout->addWidget(OnlineFriend);
    ...
    void retranslateUi(QWidget *Online)
    {
        ...
        addFriend->setText(QCoreApplication::translate("Online", "\346\267\273\345\212\240\345\245\275\345\217\213", nullptr));
    } // retranslateUi
