...
Q_CONSTINIT static const qt_meta_stringdata_CLASSMyTcpSocketENDCLASS_t qt_meta_stringdata_CLASSMyTcpSocketENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 11),  // "closeclient"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 12),  // "MyTcpSocket*"
        QT_MOC_LITERAL(38, 8),  // "mysocket"
        QT_MOC_LITERAL(47, 7),  // "recvMsg"
        QT_MOC_LITERAL(55, 11),  // "clientclose"
        QT_MOC_LITERAL(67, 8)   // "sendfile"
    },
    "MyTcpSocket",
    "closeclient",
    "",
...
void MyTcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->closeclient((*reinterpret_cast< std::add_pointer_t<MyTcpSocket*>>(_a[1]))); break;
        case 1: _t->recvMsg(); break;
        case 2: _t->clientclose(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &MyTcpSocket::closeclient; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTcpSocket::closeclient(MyTcpSocket * _t1)
{
